    ...
    <div class="post-card">
        ...
        <p>
            ...
            <?php if(strlen($row->content) >= 150){ ?>
                ...<a class="btn btn-primary" href="<?php echo base_url() ?>index.php/post/view/<?php echo $row->id; ?>" role="button">Читать дальше</a>
            <?php } ?>
        </p>
        </div>
...
<footer class="footer">
    <div class="view-all">
        <p><a href="<?php echo base_url(); ?>index.php/post/all_post">Показать все программы обучения</a></p>
    </div>
</footer>